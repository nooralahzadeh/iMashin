            ...
            <ScrollView>
                <View style={[css.sideMenuLeft, this.props.menuBody]}>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={[css.menuLinkLeft, this.props.textColor]}>آگهی های من</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={[css.menuLinkLeft, this.props.textColor]}>آکهی های دلخواه</Text>
                    ...
                    <TouchableOpacity
                      ...
                      >
                        ...
                        <Text style={[css.menuLinkLeft, this.props.textColor]}>پروفایل</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={[css.menuLinkLeft, this.props.textColor]}>تنظیمات جستحو</Text>
                    </TouchableOpacity>
